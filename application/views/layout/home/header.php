...
<head>
    ...
    <title><?= $title ?> | ASVARAJAVA</title>
    <!-- BEGIN: CSS Assets-->
    <link rel="stylesheet" href="<?= site_url('asset') ?>/admin/dist/css/app.css" />
    <link href="<?php echo base_url('asset/materialize/css/meterial-icons.css'); ?>" type="text/css" rel="stylesheet" media="screen,projection"/>
    ...
    <div class="top-bar-boxed h-[70px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12">
        <div class="h-full flex items-center">
            ...
            <a href="" class="-intro-x hidden md:flex">
                <img alt="Midone - HTML Admin Template" class="w-6" src="<?= site_url('asset') ?>/images/login.png">
                <span class="text-white text-lg ml-3"> ASVARAJAVA </span>
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
